...
public class Executavel {
	public static void main(String[] args) {
		...
		Aluno aluno1 = new Aluno(nome, idade, dataNascimento, rg, cpf, nomeMae, nomePai, dataMatricula, nomeEscola, serieMatriculado, nota1, nota2, nota3, nota4);
		...
		System.out.println("Média do Aluno: "+ aluno1.getMediaNota()+ ""
				+ "\nResultado: " + (aluno1.getAlunoAprovado()? "Aprovado" : "Reprovado")); //operador ternário
